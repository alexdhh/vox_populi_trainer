    ...
    public partial class GenerateDataPageViewModel : BaseViewModel
    {
        ...
        private void GenerateDataset(int sampleCount)
        {
            try
            {
                ...
                // ================== MATRICES CENTRE ==================
                string[] sujets_c = { "L'Europe", "Le président", "La majorité présidentielle", "Le gouvernement", "L'État stratège", "La République en marche", "Le bloc central", "La coalition", "Les partenaires européens", "L'économie de marché régulée", "La flexisécurité", "Le pragmatisme", "La méritocratie", "La laïcité", "L'autorité de l'État", "Le dépassement des clivages", "La société du travail", "L'Union européenne", "L'axe central", "Le progrès", "L'innovation", "La souveraineté européenne", "La réindustrialisation", "Le compromis", "La réforme", "L'équité", "L'égalité des chances", "La croissance", "L'attractivité du pays", "Le dialogue social", "L'émancipation", "L'entreprise", "Le rassemblement", "Les forces progressistes", "La nation européenne", "L'investissement", "La transition écologique et économique", "La concertation", "Le bon sens", "Le projet européen", "Le camp républicain", "La responsabilité", "La transformation du pays", "L'audace", "Le pragmatisme économique", "L'action gouvernementale", "L'exécutif", "Le Parlement", "Les modérés", "La force d'équilibre" };
                string[] actions_c = { "doit réformer", "a le devoir de transformer", "se doit d'équilibrer", "doit investir dans", "a pour obligation d'optimiser", "doit accompagner", "se doit de moderniser", "doit encourager", "a la responsabilité d'adapter", "doit libérer", "se doit de protéger", "doit stimuler", "a le mandat de réguler", "doit soutenir", "a l'impératif de concilier", "doit simplifier", "doit évaluer", "se doit de faciliter", "doit promouvoir", "a la charge de structurer", "ne doit pas opposer", "ne peut plus ignorer la réalité de", "ne doit pas bloquer", "ne doit en aucun cas freiner", "ne peut plus reculer sur", "ne doit pas céder aux extrêmes", "ne doit jamais diviser sur", "ne peut plus repousser", "ne doit pas stigmatiser", "ne doit en aucun cas alourdir", "doit assainir", "se doit de rationaliser", "a l'urgence d'innover", "doit dépasser", "ne peut plus laisser faire", "ne doit en aucun cas paralyser", "doit responsabiliser", "doit pacifier", "se doit de rassembler", "doit relancer", "ne doit jamais céder au populisme", "a la mission historique d'unir", "doit financer intelligemment", "ne peut plus tolérer le statu quo de", "doit urgemment transformer", "doit accompagner en douceur", "se doit de piloter", "doit revitaliser", "ne doit plus compliquer", "doit encadrer" };
                string[] cibles_c = { "les finances publiques", "le marché du travail", "la formation professionnelle", "le système de retraite", "la compétitivité des entreprises", "le dialogue social", "la transition numérique", "les services de l'État", "l'apprentissage", "le pouvoir d'achat", "l'intégration européenne", "l'innovation technologique", "la dette publique", "les PME et TPE", "l'investissement productif", "la fiscalité", "la gabegie administrative", "le système de santé", "les start-ups", "l'éducation", "les partenaires sociaux", "la flexibilité du travail", "l'assurance chômage", "les territoires", "l'emploi des jeunes", "la transition énergétique", "l'administration", "la croissance verte", "la laïcité", "les filières d'avenir", "la cohésion nationale", "le secteur privé", "le marché intérieur", "l'Europe de la défense", "le mix énergétique", "l'ordre républicain", "la réindustrialisation", "le plein emploi", "la souveraineté industrielle", "l'outil de production", "les métiers en tension", "la mobilité sociale", "l'égalité femmes-hommes", "le tissu économique", "l'attractivité fiscale", "la recherche et développement", "la gabegie de l'État", "les infrastructures", "les accords de libre-échange", "la fonction publique" };
                string[] objectifs_c = { "pour libérer la croissance.", "afin de protéger en même temps.", "pour garantir le plein emploi.", "dans le but d'assainir nos comptes.", "pour assurer la place de la France en Europe.", "afin de lutter contre les rentes.", "pour le progrès économique et social.", "dans le but de faire réussir le pays.", "pour construire une souveraineté européenne.", "afin d'aider ceux qui travaillent.", "pour combattre le chômage de masse.", "afin de réduire les déficits sans casser la croissance.", "pour que l'effort soit récompensé.", "dans un souci d'efficacité et de justice.", "pour émanciper par le travail.", "afin de préserver le modèle social.", "pour soutenir la création d'entreprises.", "dans le but de simplifier la vie des citoyens.", "pour en finir avec les blocages.", "afin de partager les fruits de la croissance.", "pour ne laisser personne sur le bord du chemin.", "afin de ne pas céder aux sirènes du populisme.", "pour éviter le déclin.", "afin de ne pas hypothéquer l'avenir des jeunes.", "pour éviter toute gabegie.", "afin de ne jamais opposer l'économie et le social.", "pour mettre fin aux dogmatismes.", "afin d'empêcher la fuite des talents.", "pour instaurer une véritable méritocratie.", "afin de reprendre le contrôle de notre destin.", "pour réparer le pays.", "afin de moderniser l'État.", "pour faire payer ceux qui fraudent.", "afin de sécuriser les parcours professionnels.", "pour empêcher le déclassement.", "afin d'enrayer le chômage structurel.", "pour redonner confiance aux acteurs économiques.", "afin de bâtir l'Europe de demain.", "pour ne plus subir la mondialisation.", "afin d'assurer la pérennité de notre système.", "pour mettre l'innovation au cœur de notre modèle.", "afin d'en finir avec le corporatisme.", "pour refonder notre contrat social.", "afin de garantir l'égalité des chances.", "pour que le travail paie toujours plus.", "afin d'éradiquer la bureaucratie inutile.", "pour promouvoir une écologie de résultats.", "afin d'interdire les pratiques déloyales.", "pour sanctuariser les investissements d'avenir.", "afin de respecter nos engagements européens." };
                ...
                using (var writer = new StreamWriter(localPath, false, System.Text.Encoding.UTF8))
                {
                    for (int i = 0; i < datasetIndices.Count; i++)
                    {
                        ...
                        {
                            label = "Centre";
                            phrase = $"{sujets_c[s_idx]} {actions_c[a_idx]} {(c_idx < 50 ? cibles_c[c_idx] : "")} {(o_idx < 50 ? objectifs_c[o_idx] : "")}";
                        }
                        else
                        {
                            label = "Droite";
